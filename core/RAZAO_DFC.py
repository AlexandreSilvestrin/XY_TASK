...
class RAZAO_DFC:
    ...
    def gerar_dfc(self, local, locals, nomearq):
        try:
            return self._gerar_dfc(local, locals, nomearq)
    ...
    def _gerar_dfc(self, local, locals, nomearq):
...
class RazaoDfcWeb(RAZAO_DFC):
    def __init__(self, local, locals, list_contra, emit_log):
